            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-12">
                    ...
                    <div class="success-inner">
                        ...
                        <p>Mr/Mdme {{ $data['mon_nom'] }}&nbsp;{{ $data['mon_prenoms'] }}, votre demande d'acte
                            académique enregistrer sous le numéro <u><b>{{ $data['mon_code'] }}</b></u> a été traiter et
                            valider.</p>
                        ...
                        <div class="mt-2 mb-2">
                            ...
                            <div class="col ps-0">
                                <a href="{{asset('storage/'.$data['fichier'])}}" class="text-muted fw-bold"
                                    download>Télécharger ici votre document</a>
                                <p class="mb-0"></p>
                            </div>
                            </p>
                            <p>
