                ...
                <div class="col-lg-6 offset-lg-3 col-12">
                    ...
                    <div class="success-inner">
                        ...
                        <p>Mr/Mdme {{ $data['nom'] }}&nbsp;{{ $data['prenoms'] }}, votre demande d'acte académique a été
                            reçu et bien enregistrer sous le code de demande <u><b>{{ $data['code_demande'] }}.</b></u>
                        </p>
                        <p>Suivez, désormais votre demande sur notre site avec votre code de demande.</p>

                        <div class="mt-2 mb-2">
                            <p>
                                <i>Merci, Facultés des Sciences Humaines et Sociales d'Université d'Abomey-Calavi
                                </i>
                            </p>
                        </div>
