<div class="modal fade bd-example-modal-lg-edit-sous-{{$childCategory->id}}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{route('acte.update',$childCategory->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" readonly
                            value="{{ old('code') ? old('code') : $childCategory->code }}" class="form-control"
                            data-toggle="input-mask">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Nom<span style="color: red;">*</span></label>
                        <input type="text" name="nom" value="{{ old('nom') ? old('nom') : $childCategory->nom }}"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select select2" data-toggle="select2"
                            ...
                            <option value="{{ $act->id }}"
                                {{ $act->id == $childCategory->acte_parent_id ? 'selected' : '' }}>
                                {{ $act->nom }}</option>
                            @endif
                            @empty
